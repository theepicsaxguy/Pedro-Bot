...
const { SlashCommandBuilder, PermissionsBitField, ActionRowBuilder,MessageFlags, parseEmoji, ButtonBuilder, ButtonStyle, EmbedBuilder } = require('discord.js');
    ...
    async execute(interaction) {
        ...
        if (subcommand === 'create') {
            ...
            for (let i = 1; i <= 4; i++) {
                ...
                if (emoji && role) {
                    // Use Discord.js parseEmoji to validate emojis
            ...
            roles.forEach((roleObj, index) => {
                const button = new ButtonBuilder()
                    ...
                    .setLabel(' ') // Label is left blank since emoji is used
